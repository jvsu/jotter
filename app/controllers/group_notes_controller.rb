...
class GroupNotesController < ApplicationController
  def create
   ...
   #    redirect_to "/groups/select/#{gn_params[:group_id]}"
      json_data = {message:"success", note_id:gn_params[:note_id],group_id:gn_params[:group_id],user_id:gn_params[:user_id], action:"add", gn_id:group_note.id}
      render json:json_data
    else
    #   # flash[:message] ='No success'
    #   # redirect_to "/groups/select/#{gn_params[:group_id]}"
      json_data = {message:"fail", note_id:gn_params[:note_id],group_id:gn_params[:group_id],user_id:gn_params[:user_id], gn_id:group_note.id,action:"add"}
      render json:json_data
    end
  end
  ...
  def delete
      ...
      # flash[:message] ='Note Removed'
      # redirect_to "/groups/view/#{gn_delete_params[:group_id]}"
      json_data = {message:"success", note_id:gn_delete_params[:note_id],group_id:gn_delete_params[:group_id],user_id:gn_delete_params[:user_id], action:"remove"}
      render json:json_data
    end
  end
